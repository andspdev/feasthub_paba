...
class WishlistAdapter (
    ...
    interface OnItemClickCallback {
        ...
        fun onItemDeleteCallback(data: ItemsArray)
    }
    ...
    inner class ListViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val _imgWishlist: ImageView = itemView.findViewById(R.id.imgWishlist)
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        val view : View = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_rv_wishlist, parent, false)
    ...
    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        ...
        holder._imgWishlist.setOnClickListener {
            onItemClickCallback.onItemDeleteCallback(item)
        }
    }
